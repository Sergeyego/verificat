    ...
    , ui(new Ui::MainWindow)
{
    ...
    actAction(ui->actionDev,&MainWindow::newFormDev);
    actAction(ui->actionVer,&MainWindow::newFormVer);
    actAction(ui->actionRep,&MainWindow::newFormRep);
...
void MainWindow::newFormDev()
{
    if (!exist(sender())){
        addSubWindow(new FormDev(),sender());
    }
}

void MainWindow::newFormVer()
{
    if (!exist(sender())){
        addSubWindow(new FormVer(),sender());
    }
}

void MainWindow::newFormRep()
{
    if (!exist(sender())){
        addSubWindow(new FormRep(),sender());
    }
}
